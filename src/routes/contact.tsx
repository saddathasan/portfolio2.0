      ...
      >
              ...
              <Card className="hover:shadow-md transition-shadow">
                ...
                <CardContent>
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Talvette Limited</p>
        ...
        >
          <Card className="max-w-2xl mx-auto">
            <CardHeader>
              <CardTitle>Looking for my resume?</CardTitle>
              <CardDescription>
                Download my detailed resume or check out my latest projects and experience.
              </CardDescription>
            </CardHeader>
            <CardContent>
