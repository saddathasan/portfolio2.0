...
const drafts: Array<{
...
}> = [
	{
		...
		summary:
			"Thoughts on building a lean, evolvable design system without over-engineering.",
		date: "2025-09-12",
	},
	{
		...
		summary:
			"Approaching web performance as a product constraint rather than an optimization afterthought.",
		date: "2025-08-03",
	},
];
			...
			<PageLayout.Main maxWidth="3xl">
				<PageHeader>
					...
					<PageHeader.Description>
						Occasional essays, implementation notes, and distilled
						lessons from building real products.
					</PageHeader.Description>
				</PageHeader>
