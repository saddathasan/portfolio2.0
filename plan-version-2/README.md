...
|---|-----|------|---------------|--------|
| 0 | [`01-phase-0-cleanup.md`](./01-phase-0-cleanup.md) | Strip cruft, one router, one design system, feature-based structure | 2–3 | ☐ Not started |
| 1 | [`02-phase-1-terminal.md`](./02-phase-1-terminal.md) | Terminal v2: agnoster prompt, command registry, autocomplete, history, `gui` switch | 3–4 | ☐ Not started |
